...
export default function ShopPD() {
                ...
                <Box sx={{
                    ...
                    <Box sx={{
                        ...
                        <Box sx={{ 
                            ...
                            <Box sx={{ flex: 1 }}>
                                <img
                                    src="https://lazeapostolski.com/industrial2/img/shop1.jpg"
                                    alt="Portable Drill"
                                    style={{ 
                                        width:"100%",
                                        // width: {sm:'500px' ,md:'100%'},
                                         objectFit: 'cover' }}
                                />
                            </Box>
                            ...
                            <Box sx={{ flex: 1 }}>
                                <Typography variant="h5" fontWeight="bold">Portable Drill 2000W</Typography>
                                <Rating value={4} readOnly sx={{ mb: 1 }} />
                                <Typography variant="h6" color="#fbae19">$39.00</Typography>

                                <Typography sx={{ my: 2 }}>
                                    Lorem ipsum dolor sit amet, consectetur adi pisi cing elit, sed do eiusmod tempor exercitationemut.
                                    Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipis civelit sed quia
                                    non qui dolorem or phone +11 987 654 3210
                                </Typography>
                                <Box sx={{    
                                    my: 3,
                                }}>
                                ...
                                <Typography variant="body2" color="text.secondary">Category: Machine, Industry</Typography>
                                <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>Tags: Construction, Science</Typography>
                        ...
                        <Box  sx={{
                            ...
                            <Box sx={{ display: 'flex', gap: 2, mb: 0 ,
                                ...
                                <Button
                                    ...
                                    sx={{
                                        position: "relative",
                                        backgroundColor: activeTab === 'description' ? '#fbae19' : 'transparent',
                                        color: activeTab === 'description' ? 'black' : 'black',
                                        borderTop: activeTab === 'description' ? '4px solid #fbae19' : 'white',
                                        borderRight: activeTab === 'description' ? '4px solid #fbae19' : 'white',
                                        borderLeft: activeTab === 'description' ? '4px solid #fbae19' : 'white',
                                        borderBottom: activeTab === 'description' ? 'white' : 'white',
                                        borderRadius: 0,
                                        textTransform: 'none',
                                        width: '120px',
                                ...
                                <Button
                                    ...
                                    sx={{
                                        ...
                                        backgroundColor: activeTab === 'reviews' ? '#fbae19' : 'transparent',
                                        color: activeTab === 'reviews' ? 'black' : 'black',
                                        borderTop: activeTab === 'reviews' ? '4px solid #fbae19' : 'white',
                                        borderRight: activeTab === 'reviews' ? '4px solid #fbae19' : 'white',
                                        borderLeft: activeTab === 'reviews' ? '4px solid #fbae19' : 'white',
                                        borderBottom: activeTab === 'reviews' ? 'white' : 'white',
                                        borderRadius: 0,
                                        width: '120px',
                                        textTransform: 'none',
                                        boxShadow: 0,
                            ...
                            <Box sx={{     
                                border: "4px solid #fbae19",
                                height: {xs:"%",sm:"14rem",md:"12rem", lg:"10rem"},
                                py:5,

                            }}>
                                {activeTab === 'description' ? (
                                    <Typography sx={{ px: 4, }}>
                                        Fusce non faucibus lorem. Cras eu velit id diam cursus tincidunt in ut dui. Quisque quis augue
                                        placerat, pulvinar dui aliquam, convallis sapien. Orci varius natoque penatibus et magnis dis
                                    ...
                                    <>
                                        {[1, 2].map((_, i) => (
                                            <Box key={i} sx={{ display: 'flex', gap: 2, mb: 3, px: 4 }}>
                                                <Avatar
                                                ...
                                                />
                                                <Box>
                                                    <Typography fontWeight="bold">Joana Steevanson - 13 Fev, 2017</Typography>
                                                    <Typography>
                                                        Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id
