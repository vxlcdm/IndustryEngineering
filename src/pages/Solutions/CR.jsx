                 ...
                 <Box
                    ...
                    <Box
                        ...
                        sx={{
                            ...
                            Home&gt; About Us &gt;  <span style={{ color:"#fbae19"}}>Chemical Research</span>
                        </Typography>
                    </Box>
                                ...
                                <List sx={{
                                    ...
                                    {fields.map((text, index) => (
                                        <ListItem button key={index} sx={{
                                            bgcolor: index === 1 ? "#062d4c" : "#eeeeee",
                                            color: index === 1 ? "white" : "black",
                                            borderLeft: index === 1 ? "4px solid #fbae19":"",
                                            my:0.6,
                                            mt:0,
                                            // mb:0,
                                            // m:0,
                        ...
                        >
                            <Box
                                sx={{
                                    height: "40vh",
                                    width: "100%",
                                    backgroundImage: 'url("https://lazeapostolski.com/industrial2/img/chemical.jpg")',
                                    backgroundSize: "cover",
                                    backgroundPosition: "center",
                            ...
                            >
                                <Typography
                                    ...
                                    sx={{
                                        color: "#fff",
                                        fontWeight: "bold",
                                        textShadow: "0px 0px 60px rgba(0, 0, 0, 0.99)",
                                    }}
                                >
