...
export default function CR(){
    ...
    <Box>
                 ...
                 <Box
                    ...
                    Solutions  &gt;  <span style={{ color: "#fbae19" }}> Power and Energy  </span>
                        </Typography>
                    </Box>
                                ...
                                <List sx={{
                                    ...
                                    {fields.map((text, index) => (
                                        <ListItem button key={index} sx={{
                                            bgcolor: index === 2 ? "#062d4c" : "#eeeeee",
                                            color: index === 2 ? "white" : "black",
                                            borderLeft: index === 2 ? "4px solid #fbae19":"",
                                            my:0.6,
                                            mt:0,
                                            // mb:0,
                                            // m:0,
                            ...
                            >
                                <Box
                                    sx={{
                                        width: { xs: "100%", md: "40%" },
                                        height: { xs: "50%", md: "100%" },
                                        backgroundImage: 'url("https://lazeapostolski.com/industrial2/img/power2.jpg")',
                                        backgroundSize: "cover",
                                        backgroundPosition: "center",
                                ...
                                <Box
                                    sx={{
                                        width: { xs: "100%", md: "60%" },
                                        height: { xs: "50%", md: "100%" },
                                        backgroundImage: 'url("https://lazeapostolski.com/industrial2/img/power1.jpg")',
                                        backgroundSize: "cover",
                                        backgroundPosition: "center",
                                        backgroundRepeat: "no-repeat",
                                    }}
