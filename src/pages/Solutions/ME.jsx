        ...
        <Box>
            ...
            <Box
                ...
                <Typography
                    ...
                    Solutions  &gt;  <span style={{ color: "#fbae19" }}>   Mechanical Engineering    </span>
                </Typography>
            </Box>
                                ...
                                <List sx={{
                                    ...
                                    {fields.map((text, index) => (
                                        <ListItem button key={index} sx={{
                                            bgcolor: index === 3 ? "#062d4c" : "#eeeeee",
                                            color: index === 3 ? "white" : "black",
                                            borderLeft: index === 3 ? "4px solid #fbae19" : "",
                                            my: 0.6,
                                            mt: 0,
                                            // mb:0,
                                            // m:0,
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Typography
                                        sx={{
                                            fontSize: "0.8rem",
                                            lineHeight:{xs:"1rem",sm:"1rem", md:"1.1rem", lg:"1.6rem"},
                                            // height: { xs: "30vh", md: "100%" },
                                            color: "#333",
